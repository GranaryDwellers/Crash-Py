---
layout: page
title: "Lesson 17a: Project — Manual of Me"
permalink: /lessons/17a-manual-of-me/
---
...
**Markdown** (Lesson 14) and **GitHub Pages** (Lesson 17).
...
- Lesson 14 — Markdown (headings, lists, tables, links).
- Lesson 15 — Git (init, add, commit).
- Lesson 16 — GitHub (creating a repository, pushing).
- Lesson 17 — GitHub Pages (enabling Pages, `_config.yml`, front matter).

If you can already publish the classroom blog from Lesson 17, you have
...
username — exactly as you did for the classroom blog in Lesson 17.
...
everything you learned about Markdown in Lesson 14 — headings, lists, and a
...
Just like the classroom blog in Lesson 17:
...
If you installed Ruby and Bundler back in Lesson 17, you can preview the site
...
[← Lesson 17: GitHub Pages]({{ site.baseurl }}/lessons/17-github-pages/)
[Next Lesson: JSON →]({{ site.baseurl }}/lessons/18-json/)
