...
permalink: /lessons/11-dictionaries/
---
...
> **Download:** [dictionaries.py]({{ site.baseurl }}/resources/lesson-11/dictionaries.py)
...
2. Given a list of student scores, write code to build a dictionary mapping
   each score to its grade using the `grade()` function from Lesson 9.
...
[← Project: Sieve of Eratosthenes]({{ site.baseurl }}/lessons/10a-sieve-of-eratosthenes/)
